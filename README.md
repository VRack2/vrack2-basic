...
## Основные рекомендации
 ...
 1. Каждое устройство должно решать одну конкретную задачу или иметь одну четко определенную зону ответственности. Его конструкция должна быть минимально необходимой для достижения этой цели.
 2. Общая сложность системы должна быть оптимизирована за счет нахождения баланса между сложностью отдельных устройств и их количеством. Предпочтение отдается модификации существующих устройств перед созданием новых, если это не нарушает Принцип 1..
 3. Логика, являющаяся общей для нескольких задач, должна быть выделена в отдельное, независимое устройство. Это устройство должно предоставлять четкий интерфейс для использования другими устройствами, не нарушая Принципы 1 и 2.
