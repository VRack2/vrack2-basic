...
1. Каждое устройство должно иметь одну четко определенную зону ответственности. 
2. Общая сложность системы должна быть оптимизирована за счет нахождения баланса между сложностью отдельных устройств и их количеством. Предпочтение отдается модификации существующих устройств перед созданием новых
3.  Логика, являющаяся общей для нескольких задач, должна быть выделена в отдельное, независимое устройство.
